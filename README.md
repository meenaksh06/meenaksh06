...
I build scalable AI-powered systems, real-time architectures, and developer tools focused on solving real-world problems.
...
- **HPAIR Delegate (2024–2026)** | **2nd Place – StealthFire Hackathon**  
- Contributor to **Trigger.dev ecosystem (async systems & infrastructure)**  
...
**DevOps:** Docker, Kubernetes, AWS EC2, Vercel, Render, GitHub  
...
- Intelligent scheduling and automation pipelines  
...
### Encryption Tool  
- Secure communication using modern cryptographic methods  

### Blomo  
Real-time blood donation platform  
- Emergency matching and location-based discovery  
...
- Contributed to scalable workflow automation infrastructure  
